...
export const Contact = {
    ...
    validate: {
        name: 'Please, insert a name before send.',
        email: 'Please, insert an email before send.',
        message: 'I´m sure that if you send me a message it´s because you want to talk to me about something ... haven´t you forgotten a field?'
    },
    error: 'Oops! Something is wrong. Try again later.',
    success: 'Message sent succesfully. I will contact you soon :)'
};
